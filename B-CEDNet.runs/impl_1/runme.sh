...
HD_PWD='F:/Vivado_prj/B-CEDNet/B-CEDNet.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log BCEDN_TOP.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source BCEDN_TOP.tcl -notrace
