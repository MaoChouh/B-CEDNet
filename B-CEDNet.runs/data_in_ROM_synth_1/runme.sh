...
HD_PWD='F:/Vivado_prj/B-CEDNet/B-CEDNet.runs/data_in_ROM_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log data_in_ROM.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source data_in_ROM.tcl
