...
HD_PWD='F:/Vivado_prj/B-CEDNet/B-CEDNet.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log BCEDN_TOP.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source BCEDN_TOP.tcl
