...
# DVE full session
# Saved on Sat Jan 14 11:42:57 2017
# Designs open: 1
#   V1: /home/tensor_v1/mnt/BCEDN_TMP/BCEDN_TOP_tb_waveform_2.vpd
...
#<Session mode="Full" path="/home/tensor_v1/project/B-CEDNet/test/BCEDN_ENDECODER_tb/output/DVEfiles/session.tcl" type="Debug">
...
gui_show_window -window ${TopLevel.2} -show_state normal -rect {{76 93} {1918 1075}}
...
if { ![gui_is_db_opened -db {/home/tensor_v1/mnt/BCEDN_TMP/BCEDN_TOP_tb_waveform_2.vpd}] } {
	gui_open_db -design V1 -file /home/tensor_v1/mnt/BCEDN_TMP/BCEDN_TOP_tb_waveform_2.vpd -nosource
}
...
gui_wv_zoom_timerange -id ${Wave.1} 0 40961025
