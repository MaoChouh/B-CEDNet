...
# DVE full session
# Saved on Sun Jan 8 10:46:16 2017
# Designs open: 1
#   V1: BCEDN_DECODER_tb_waveform.vpd
...
#<Session mode="Full" path="/home/tensor_v1/project/B-CEDNet/test/BCEDN_ENDECODER_tb/output/session.BCEDN_DECODER_tb_waveform.vpd.tcl" type="Debug">
...
gui_show_window -window ${TopLevel.1} -show_state normal -rect {{6 79} {1860 1075}}
...
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 387} {height 736} {dock_state left} {dock_on_new_line true} {child_hier_colhier 312} {child_hier_coltype 107} {child_hier_colpd 0} {child_hier_col1 0} {child_hier_col2 1} {child_hier_col3 -1}}
...
gui_update_layout -id ${DLPane.1} {{left 0} {top 0} {width 331} {height 736} {dock_state left} {dock_on_new_line true} {child_data_colvariable 168} {child_data_colvalue 122} {child_data_coltype 70} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2}}
...
gui_update_layout -id ${DriverLoad.1} {{left 0} {top 0} {width 1558} {height 179} {dock_state bottom} {dock_on_new_line false}}
...
gui_show_window -window ${TopLevel.2} -show_state normal -rect {{73 90} {1918 1075}}
...
if { ![gui_is_db_opened -db {BCEDN_DECODER_tb_waveform.vpd}] } {
	gui_open_db -design V1 -file BCEDN_DECODER_tb_waveform.vpd -nosource
}
...
gui_sg_addsignal -group "$_session_group_4" { BCEDN_ENDECODER_tb.endecoder_inst.edc_ctrl_inst.pad_mux_sel BCEDN_ENDECODER_tb.endecoder_inst.edc_ctrl_inst.clk BCEDN_ENDECODER_tb.endecoder_inst.edc_ctrl_inst.rst BCEDN_ENDECODER_tb.endecoder_inst.edc_ctrl_inst.data_in_en BCEDN_ENDECODER_tb.endecoder_inst.edc_ctrl_inst.start BCEDN_ENDECODER_tb.endecoder_inst.edc_ctrl_inst.fmap_in_shiftreg_en BCEDN_ENDECODER_tb.endecoder_inst.edc_ctrl_inst.fmap_out_shiftreg_en BCEDN_ENDECODER_tb.endecoder_inst.edc_ctrl_inst.w_rom_en BCEDN_ENDECODER_tb.endecoder_inst.edc_ctrl_inst.w_rom_addr BCEDN_ENDECODER_tb.endecoder_inst.edc_ctrl_inst.pe_en BCEDN_ENDECODER_tb.endecoder_inst.edc_ctrl_inst.upool_mux_sel BCEDN_ENDECODER_tb.endecoder_inst.edc_ctrl_inst.data_out_en BCEDN_ENDECODER_tb.endecoder_inst.edc_ctrl_inst.tg_next BCEDN_ENDECODER_tb.endecoder_inst.edc_ctrl_inst.output_count BCEDN_ENDECODER_tb.endecoder_inst.edc_ctrl_inst.state BCEDN_ENDECODER_tb.endecoder_inst.edc_ctrl_inst.col_count BCEDN_ENDECODER_tb.endecoder_inst.edc_ctrl_inst.row_count BCEDN_ENDECODER_tb.endecoder_inst.edc_ctrl_inst.p_count }
...
gui_view_scroll -id ${Source.1} -vertical -set 2363
...
gui_wv_zoom_timerange -id ${Wave.1} 0 4866268000
gui_list_add_group -id ${Wave.1} -after {New Group} {Group1}
gui_list_select -id ${Wave.1} {BCEDN_ENDECODER_tb.endecoder_inst.edc_ctrl_inst.upool_mux_sel BCEDN_ENDECODER_tb.endecoder_inst.edc_ctrl_inst.output_count BCEDN_ENDECODER_tb.endecoder_inst.edc_ctrl_inst.state BCEDN_ENDECODER_tb.endecoder_inst.edc_ctrl_inst.col_count BCEDN_ENDECODER_tb.endecoder_inst.edc_ctrl_inst.row_count BCEDN_ENDECODER_tb.endecoder_inst.edc_ctrl_inst.p_count }
...
gui_marker_move -id ${Wave.1} {C1} 92265000
