...
# DVE full session
# Saved on Sat Dec 31 11:26:53 2016
# Designs open: 1
...
gui_show_window -window ${TopLevel.2} -show_state normal -rect {{0 53} {1919 1079}}
...
gui_sg_addsignal -group "$_session_group_2" { BCEDN_ENCODER_tb.encoder_inst.ec_ctrl_inst.clk BCEDN_ENCODER_tb.encoder_inst.ec_ctrl_inst.rst BCEDN_ENCODER_tb.encoder_inst.ec_ctrl_inst.start BCEDN_ENCODER_tb.encoder_inst.ec_ctrl_inst.state BCEDN_ENCODER_tb.encoder_inst.ec_ctrl_inst.output_count BCEDN_ENCODER_tb.encoder_inst.ec_ctrl_inst.col_count BCEDN_ENCODER_tb.encoder_inst.ec_ctrl_inst.row_count BCEDN_ENCODER_tb.encoder_inst.ec_ctrl_inst.fmap_in_shiftreg_en BCEDN_ENCODER_tb.encoder_inst.ec_ctrl_inst.fmap_out_shiftreg_en BCEDN_ENCODER_tb.encoder_inst.ec_ctrl_inst.w_rom_en BCEDN_ENCODER_tb.encoder_inst.ec_ctrl_inst.w_rom_addr BCEDN_ENCODER_tb.encoder_inst.ec_ctrl_inst.index_sram_en BCEDN_ENCODER_tb.encoder_inst.ec_ctrl_inst.index_sram_wr BCEDN_ENCODER_tb.encoder_inst.ec_ctrl_inst.index_sram_addr BCEDN_ENCODER_tb.encoder_inst.ec_ctrl_inst.pe_en BCEDN_ENCODER_tb.encoder_inst.ec_ctrl_inst.data_out_en BCEDN_ENCODER_tb.encoder_inst.ec_ctrl_inst.tg_next }
...
# Restore C1 time
gui_set_time -C1_only 499305000
...
gui_wv_zoom_timerange -id ${Wave.1} 494284032 533089537
gui_list_add_group -id ${Wave.1} -after {New Group} {Group1}
gui_list_select -id ${Wave.1} {BCEDN_ENCODER_tb.encoder_inst.ec_ctrl_inst.row_count }
...
gui_marker_move -id ${Wave.1} {C1} 499305000
