...
# DVE full session
# Saved on Sat Dec 31 11:45:59 2016
# Designs open: 1
...
gui_show_window -window ${TopLevel.2} -show_state maximized -rect {{0 53} {1919 1079}}
...
gui_update_layout -id ${Wave.1} {{show_state maximized} {dock_state undocked} {dock_on_new_line false} {child_wave_left 557} {child_wave_right 1357} {child_wave_colname 341} {child_wave_colvalue 212} {child_wave_col1 0} {child_wave_col2 1}}
...
gui_set_radix -radix {strength} -signals {V1:BCEDN_ENCODER_tb.encoder_inst.ec_ctrl_inst.p_count}
...
# Restore C1 time
gui_set_time -C1_only 1164905000
...
gui_wv_zoom_timerange -id ${Wave.1} 1164833773 1165023699
gui_list_add_group -id ${Wave.1} -after {New Group} {Group1}
gui_list_select -id ${Wave.1} {BCEDN_ENCODER_tb.encoder_inst.ec_ctrl_inst.state }
...
gui_marker_move -id ${Wave.1} {C1} 1164905000
