...
# DVE full session
# Saved on Mon Jan 2 12:06:26 2017
# Designs open: 1
...
#<Session mode="Full" path="/home/tensor_v1/project/B-CEDNet/test/BCEDN_ENCODER_tb/output/DVEfiles/session.tcl" type="Debug">
...
gui_show_window -window ${TopLevel.1} -show_state normal -rect {{5 120} {1860 1117}}
...
set HSPane.1 [gui_create_window -type HSPane -parent ${TopLevel.1} -dock_state left -dock_on_new_line true -dock_extent 402]
catch { set Hier.1 [gui_share_window -id ${HSPane.1} -type Hier] }
gui_set_window_pref_key -window ${HSPane.1} -key dock_width -value_type integer -value 402
gui_set_window_pref_key -window ${HSPane.1} -key dock_height -value_type integer -value -1
gui_set_window_pref_key -window ${HSPane.1} -key dock_offset -value_type integer -value 0
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 401} {height 740} {dock_state left} {dock_on_new_line true} {child_hier_colhier 312} {child_hier_coltype 107} {child_hier_colpd 0} {child_hier_col1 0} {child_hier_col2 1} {child_hier_col3 -1}}
...
gui_update_layout -id ${DLPane.1} {{left 0} {top 0} {width 345} {height 740} {dock_state left} {dock_on_new_line true} {child_data_colvariable 168} {child_data_colvalue 122} {child_data_coltype 70} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2}}
...
gui_update_layout -id ${Console.1} {{left 0} {top 0} {width 295} {height 176} {dock_state bottom} {dock_on_new_line true}}
...
gui_update_layout -id ${DriverLoad.1} {{left 0} {top 0} {width 1559} {height 176} {dock_state bottom} {dock_on_new_line false}}
...
gui_sg_addsignal -group "$_session_group_4" { BCEDN_ENCODER_tb.encoder_inst.ec_ctrl_inst.data_in_en BCEDN_ENCODER_tb.encoder_inst.ec_ctrl_inst.start BCEDN_ENCODER_tb.encoder_inst.ec_ctrl_inst.fmap_in_shiftreg_en BCEDN_ENCODER_tb.encoder_inst.ec_ctrl_inst.fmap_out_shiftreg_en BCEDN_ENCODER_tb.encoder_inst.ec_ctrl_inst.w_rom_addr BCEDN_ENCODER_tb.encoder_inst.ec_ctrl_inst.index_sram_en BCEDN_ENCODER_tb.encoder_inst.ec_ctrl_inst.index_sram_wr BCEDN_ENCODER_tb.encoder_inst.ec_ctrl_inst.index_sram_addr BCEDN_ENCODER_tb.encoder_inst.ec_ctrl_inst.w_rom_en BCEDN_ENCODER_tb.encoder_inst.ec_ctrl_inst.pe_en BCEDN_ENCODER_tb.encoder_inst.ec_ctrl_inst.data_out_en BCEDN_ENCODER_tb.encoder_inst.ec_ctrl_inst.output_count BCEDN_ENCODER_tb.encoder_inst.ec_ctrl_inst.col_count BCEDN_ENCODER_tb.encoder_inst.ec_ctrl_inst.row_count BCEDN_ENCODER_tb.encoder_inst.ec_ctrl_inst.p_count BCEDN_ENCODER_tb.encoder_inst.ec_ctrl_inst.state BCEDN_ENCODER_tb.encoder_inst.ec_ctrl_inst.clk BCEDN_ENCODER_tb.encoder_inst.ec_ctrl_inst.tg_next }
...
# Global: Highlighting
gui_highlight_signals -color #00ff00 {{BCEDN_ENCODER_tb.encoder_inst.ec_ctrl_inst.w_rom_addr[6:0]}}
...
# Restore C1 time
gui_set_time -C1_only 1999465000
...
catch { gui_list_select -id ${Data.1} {BCEDN_ENCODER_tb.encoder_inst.ec_ctrl_inst.clk }}
...
gui_get_drivers -session -id ${DriverLoad.1} -signal BCEDN_ENCODER_tb.encoder_inst.ec_ctrl_inst.index_sram_wr -time 5000 -starttime 338806673
gui_get_drivers -session -id ${DriverLoad.1} -signal {BCEDN_ENCODER_tb.encoder_inst.ec_ctrl_inst.fmap_in_shiftreg_en[0]} -time 1003625000 -starttime 1003625000
gui_get_drivers -session -id ${DriverLoad.1} -signal {BCEDN_ENCODER_tb.encoder_inst.ec_ctrl_inst.w_rom_addr[6:0]} -time 1992595000 -starttime 1992595000
gui_get_drivers -session -id ${DriverLoad.1} -signal {BCEDN_ENCODER_tb.encoder_inst.ec_ctrl_inst.w_rom_addr[6:0]} -time 1999465000 -starttime 1999465000

# Source 'Source.1'
gui_src_value_annotate -id ${Source.1} -switch false
gui_set_env TOGGLE::VALUEANNOTATE 0
gui_open_source -id ${Source.1}  -replace -active BCEDN_ENCODER_tb.encoder_inst.ec_ctrl_inst /home/tensor_v1/project/B-CEDNet/matlab/verification/../../src/soft_ip/EC_CTRL.v
gui_src_value_annotate -id ${Source.1} -switch true
gui_set_env TOGGLE::VALUEANNOTATE 1
gui_view_scroll -id ${Source.1} -vertical -set 3553
