...
# DVE full session
# Saved on Sat Jan 7 16:24:13 2017
# Designs open: 1
...
#<Session mode="Full" path="/home/tensor_v1/project/B-CEDNet/test/testbench_PE_EC/output/DVEfiles//crash_01.07:16.24/dve_session01.07:16.24.tcl" type="Debug">
...
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 388} {height 776} {dock_state left} {dock_on_new_line true} {child_hier_colhier 312} {child_hier_coltype 107} {child_hier_colpd 0} {child_hier_col1 0} {child_hier_col2 1} {child_hier_col3 -1}}
...
gui_update_layout -id ${DLPane.1} {{left 0} {top 0} {width 332} {height 776} {dock_state left} {dock_on_new_line true} {child_data_colvariable 168} {child_data_colvalue 122} {child_data_coltype 70} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2}}
...
gui_show_window -window ${TopLevel.2} -show_state minimized -rect {{0 53} {1919 1079}}
